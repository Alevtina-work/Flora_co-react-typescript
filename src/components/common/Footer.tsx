...
const Footer = () => {
  ...
  const sectionTitleClass =
    "text-xl font-semibold leading-2xl text-text-green font-sans";
  ...
  const contactLinkClass =
    "text-md leading-lg font-medium font-sans text-text-green-medium transition-colors duration-200 hover:text-primary-green";
      ...
      <div className="w-full max-w-[1134px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-12">
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12">
            <div className="flex flex-col items-start justify-start w-full md:w-[26%]">
              ...
              <p className="text-md leading-8 text-text-green-light font-normal font-sans">
